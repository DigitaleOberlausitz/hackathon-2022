...
class ActionProvider {
    ...
    constructor(
        createChatbotMessage: MessageCreator,
        setStateFunc: Dispatch<any>,
        createClientMessage: MessageCreator
    ) {
    ...
    handleFoodQuestion() {
        this.setState((prev: { messages: any }) => ({
            ...
            messages: [
                ...prev.messages,
                this.createChatbotMessage("Speisen und Getränke werden kostenlos bereitgestellt."),
            ],
        }))
    }
    handleDogExampleQuestion() {
        this.setState((prev: { messages: any }) => ({
            ...
            messages: [
                ...prev.messages,
                this.createChatbotMessage("Hier ist ein zufälliges Bild eines Hundes.", { widget: "dogPicture" }),
            ],
        }))
    }
}
